...
const productExists = new CustomError('Products Exists!',
    'Uh oh! the Style number entered is already registered', 409);
...
module.exports = { authFailed, dataInvalid, userNotFound, userExists, productNotFound, duplicateRequest, serverDown };